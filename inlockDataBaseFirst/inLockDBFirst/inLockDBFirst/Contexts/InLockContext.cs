...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DEV1201\\SQLEXPRESS; Initial Catalog=InLock_Games; user Id=sa; pwd=sa@132;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Estudios>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeEstudio)
                    .HasName("UQ__Estudios__112A5690BF34FC56")
                    .IsUnique();
            ...
            modelBuilder.Entity<Jogos>(entity =>
            {
                ...
                entity.HasIndex(e => e.NomeJogo)
                    .HasName("UQ__Jogos__89AF93E493B8D0E4")
                    .IsUnique();
            ...
            modelBuilder.Entity<TiposUsuario>(entity =>
            {
                ...
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__TiposUsu__7B406B5658949899")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuarios>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuarios__A9D105347383BA86")
                    .IsUnique();
